...
public:
	...
	void draw(GLuint shaderProgram, const mat4 & projection, const mat4 & modelview) {
		...
		GLuint uColorMode = glGetUniformLocation(shaderProgram, "color_mode");

		glUniformMatrix4fv(uProjection, 1, GL_FALSE, &projection[0][0]);
		glUniformMatrix4fv(uView, 1, GL_FALSE, &modelview[0][0]);
		glUniformMatrix4fv(uModel, 1, GL_FALSE, &triangle_M[0][0]);
		glUniform1i(uColorMode, 0); // 0 for green; 1 for red
